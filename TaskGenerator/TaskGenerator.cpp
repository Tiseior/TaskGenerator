...
// TaskGenerator.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTaskGeneratorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTaskGeneratorApp

CTaskGeneratorApp::CTaskGeneratorApp()
{
...
// Единственный объект CTaskGeneratorApp

CTaskGeneratorApp theApp;


// инициализация CTaskGeneratorApp

BOOL CTaskGeneratorApp::InitInstance()
{
